...
extension SchemaV3 {
    ...
    public final class ShiftPreset {
        ...
        @Relationship(deleteRule: .nullify, inverse: \SchemaV3.DayAssignment.preset)
        public var assignments: [SchemaV3.DayAssignment] = []
    ...
    public final class ShiftAlarm {
        ...
        @Relationship public var assignment: SchemaV3.DayAssignment?
        ...
        public init(
            ...
            assignment: SchemaV3.DayAssignment? = nil
        ) {
            self.id = id
    ...
    public final class DayAssignment {
        ...
        @Relationship public var preset: SchemaV3.ShiftPreset?
        ...
        public init(
            id: UUID = UUID(),
            date: Date,
            preset: SchemaV3.ShiftPreset? = nil,
    ...
    public final class HolidayOverride {
        ...
        public var label: String
        public var skipAlarm: Bool
        @Relationship public var replacementPreset: SchemaV3.ShiftPreset?
        ...
        public init(
            ...
            label: String,
            skipAlarm: Bool = true,
            replacementPreset: SchemaV3.ShiftPreset? = nil
        ) {
            self.id = id
            self.date = date
